    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
                ...
                PhoneAuthProvider.getInstance().verifyPhoneNumber(
                        ...
                        new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                            ...
                            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                                ...
                                Toast.makeText(Phone_Login.this, "Wait for confirmation Text ", Toast.LENGTH_LONG).show();
                            ...
                            public void onVerificationFailed(FirebaseException e) {
                                ...
                                Toast.makeText(Phone_Login.this, "Text Error is: "+exception, Toast.LENGTH_LONG).show();
            ...
            case R.id.button_confirm:
                ...
                Toast.makeText(Phone_Login.this, ""+verificationcode, Toast.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent=new Intent(Phone_Login.this,User_Reg.class);
                            ...
                            Toast.makeText(Phone_Login.this, "Text Error is: "+task.getException().getMessage(), Toast.LENGTH_LONG).show();

                            if (task.getException() instanceof FirebaseAuthInvalidCredentialsException) {
                                // The verification code entered was
                                Toast.makeText(Phone_Login.this, "The Verification code entered is invalid ", Toast.LENGTH_LONG).show();
